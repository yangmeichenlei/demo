...
public class DateUtils {
    ...
    public static  Date dateFormatObject(Object obj) {
        SimpleDateFormat format = new SimpleDateFormat(YYYY_MM_DD_HH_mm_ss);
        try {
            Date d = format.parse(String.valueOf(obj));
            return d;
    ...
    public static Date nowAddDays(Integer days){
        ...
        Date retDate = null;
        try {
            retDate = format2.parse(enddate+" 23"+":59"+":59");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return retDate;
