...
import static com.media.common.constant.WXPayConstants.*;
...
import com.media.common.constant.WXPayConstants.SignType;
...
public class WXPayUtil {
    ...
    public static String readData(HttpServletRequest request) {
		...
		try {
			...
			String line;
			for (br = request.getReader(); (line = br.readLine()) != null; e
					.append(line)) {
				if (e.length() > 0) {
					e.append("\n");
				}
