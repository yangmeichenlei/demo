...
//            throw Reflections.convertReflectionExceptionToUnchecked(e);
    ...
    public static List<Object> extractToList2(final Collection<?> collection, final String propertyName, final String v) {
        List<Object> list = new ArrayList<Object>(collection.size());

        try {
            for (Object obj : collection) {
                if (v.equals(PropertyUtils.getProperty(obj, propertyName))) {
                    list.add(obj);
                }
            }
        } catch (Exception e) {
